...
{
	var screenLg = $('body').find('.container').width() == 1250;
	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-12 col-sm-12 col-md-4 col-lg-3">' + $(element).find('.left-block').html() + '</div>';
				html += '<div class="center-block col-xs-12 col-sm-7 col-md-5 col-lg-8">';
