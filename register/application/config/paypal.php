...
$config['sandbox_username'] =   "ishmeetnarula_api1.yahoo.com";
$config['sandbox_password'] =   "XKCCK9TZTGVWCCEA";

$config['live_username']    =   "ishmeetnarula@yahoo.com";
$config['live_password']    =   "Ishmeet@123";

$config['APIUsername'] = $config['Sandbox'] ? $config['sandbox_username'] : $config['live_username'];
$config['APIPassword'] = $config['Sandbox'] ? $config['sandbox_password'] : $config['live_password'];
$config['APISignature'] = $config['Sandbox'] ? 'AvXoW-OGkmbaps0fRAXr7QQUeDIJArnti2dpMmxjiF3cRloYAD5YwAKt' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? $config['sandbox_username'] : $config['live_username'];
$config['PayFlowPassword'] = $config['Sandbox'] ? $config['sandbox_password'] : $config['live_password'];
 ...
 */
$config['ApplicationID'] = $config['Sandbox'] ? 'AXc4UNxWAVrQ79yZZyEJWFNGQNIwMLWrsqqLwox5uAgjrS8fZUysuMpmGCNmrgG3sAVdPoDNEUd9Q7dr' : 'ASaJ53VbnP4GE_unkwzVRKJiUVr7FA63rwPJnlzEX0U2coJ22oX1f3tHUv4o5gr2SxFsiNFSfFHGBnFp';

/*
 * PayPal Developer Account Email Address
 * This is the email address that you use to sign in to http://developer.paypal.com
 */
$config['DeveloperEmailAccount'] = 'ishmeetnarula@yahoo.com';
