...
|
*/
$config['rest_auth'] = False;//"session";
...
//$config['auth_override_class_method']['students']['getSessionID'] = 'none';
$config['auth_override_class_method']['customer']['login'] = 'none';
$config['auth_override_class_method']['customer']['register'] = 'none';
$config['auth_override_class_method']['customer']['forgetPassword'] = 'none';
$config['auth_override_class_method']['common']['*'] = 'none';
$config['auth_override_class_method']['stock']['addStocks'] = 'none';
$config['auth_override_class_method']['stock']['addDerivative'] = 'none';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_keys_table'] = 'tbl_customer';
...
|
*/
$config['rest_key_column'] = 'session_context';
...
|
*/
$config['rest_key_name'] = 'session_context';
...
/*
@$config['headerResponse']   =   array(
    'ok'            =>  REST_Controller::HTTP_OK,
    'created'       =>  REST_Controller::HTTP_CREATED,
    'unauthorized'  =>  REST_Controller::HTTP_UNAUTHORIZED,
    'badRequest'    =>  REST_Controller::HTTP_BAD_REQUEST,
);*/