...
class REST
{
    ...
    public function initialize($config)
    {
        ...
        if($this->_ci->session->userdata('session_context') != "" && $this->_ci->session->userdata('session_context') != null){
            $this->api_key = $this->_ci->session->userdata('session_context');
            $this->session_context = $this->_ci->session->userdata('session_context');
        }//$config['api_key'];
