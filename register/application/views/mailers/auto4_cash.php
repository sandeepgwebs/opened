                ...
                <tr>
                    <td class="container-padding content" align="left" style="">
                        ...
                        <div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
                            ...
                            Thank you for submitting the documents on MINT STREET. As you had selected the Online Submission option, they will be submitted to generate a unique investor identity number (CAN) issued by the MF Utilities Pvt. Ltd., a Mutual Fund (MF) industry body. We will reach out to you in case further documents / clarifications are required for completing the registration.
                            <br /><br />

                            <strong>CASHBACK – Congratulations you have just earned a cashback of Rs. <?php echo $emailData['cashback_amount'];?>.</strong> <br /><br />
                            This amount shall be credited to your registered bank account within 15 business days, provided the documents provided by you are complete and accepted by the regulatory body.
                            <br /><br />
