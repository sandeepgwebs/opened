                ...
                <tr>
                    <td class="container-padding content" align="left" style="">
                        ...
                        <div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
                            ...
                            We acknowledge the receipt of your request for investment in the Best Mutual Funds. Please complete your one-time registration formalities within 15 minutes and earn a cashback of Rs. <?php echo $emailData['cashback_amount'];?>. <br />
                            Complete registration by <a href="<?php echo base_url('account/login');?>" class="color-theme">clicking on this link</a>.<br /><br />
                            ...
                            <table width="264" border="1" cellpadding="5" cellspacing="0" align="right" class="force-row">
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class="col" valign="top" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333;width:100%"><?php echo $scheme['amount'];?></td>
                                            </tr>
                                <?php
                                        }
                                    }
                            ...
                            Please note: MINT STREET cannot be held responsible for errors or delays in processing your request due to errors in the documents/information provided by you. MINT STREET offers cashback on specific plans only from time-to-time. The offered cashback amount shall be credited to your registered bank account after 15 business days of the transaction done.
