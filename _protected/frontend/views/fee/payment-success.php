                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <p>Payment for your <?= Yii::$app->name ?> submission is successful. Your Payumoney payment transaction id is <span style="color:#00dd00;font-weight:bold"><?= $model->payment_id ?></span>.<br><br>Please send all required documents i.e. papers in IRES format,copyright form, registration form, fee transaction proof and student id(if applicable) on icires2017@gmail.com</p>
