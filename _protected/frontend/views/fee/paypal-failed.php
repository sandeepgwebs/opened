                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <p>Payment for your <?= Yii::$app->name ?> submission has failed. Your Paypal payment transaction id is <span style="color:#dd0000;font-weight:bold"><?= $model->payment_id ?></span></p>
