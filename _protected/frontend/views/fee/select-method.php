<?php
$this->title = "Select Method of payment";
	...
	<section id="about">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<?= Html::a('Register and Upload Pay Slip', ['fee/update-reciept', 'id' => 1], ['class' => 'paymenta1']) ?>
			</div>
			</div>
			<!--div class="col-md-4">
			<div class="col-md-12">
				...
				<?= Html::a('Register And Pay', ['fee/make-payment', 'id' => 2], ['class' => 'paymenta2']) ?>
			</div>
			</div-->
			<div class="col-md-6">
			<div class="col-md-12">
				...
				<?= Html::a('Register And Pay', ['fee/make-payment', 'id' => 3], ['class' => 'paymenta3']) ?>
			</div>
			</div>
		</div>
	</div>
