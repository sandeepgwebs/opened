...
class settings implements BootstrapInterface {
    ...
    */
    ...
    public function bootstrap($app) {
		...
		Yii::$app->params['settings']['is_live'] = 1;
		...
		Yii::$app->params['uploadurl'] = str_replace('/backend','',Yii::getAlias('@webroot'));		Yii::$app->params['websiteurl'] = str_replace('/backend','',Url::home(true));
